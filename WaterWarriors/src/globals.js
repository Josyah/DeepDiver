...
exports.GLOBALS = {
  ...
  initCharacterPosition: {
    x: Dimensions.get('screen').height*.5,
    y: Dimensions.get('screen').height*.5,
  },
  ...
  pickups: {
    harpoon: {
      src: require('./images/HarpoonPickup.png')
    },
    boost: {
      src: require('./images/BoostIcon.png')
    },
    health: {
      src: require('./images/HealthPickup.png')
    },
    doublecoin: {
      src: require('./images/DoubleCoinPickup.png')
    },
    coin: {
  ...
  pixelsInAMeter: Dimensions.get('screen').height/10,
  playerMass: 95.2544,
  seaWeedDistance: 50,
